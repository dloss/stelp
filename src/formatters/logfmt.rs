...
impl LogfmtFormatter {
    pub fn new(use_colors: bool) -> Self {
        Self {
            ...
            timestamp_keys: vec![
                "timestamp", "ts", "time", "at", "_t", "@t", "@timestamp"
            ],
            level_keys: vec![
                "level", "loglevel", "log_level", "lvl", "severity", "levelname", "@l"
            ],
            message_keys: vec![
                "message", "msg", "@m", "@message", "text", "content"
            ],
        }
    }
    ...
    pub fn sort_fields_by_priority<'a>(&self, fields: &'a HashMap<String, String>) -> Vec<(&'a String, &'a String)> {
